...
const adminLinks: DropdownLink[] = [
    ...
    },
    {
        ...
        dropdown: [
            ...
            { label: 'User Object Permissions', link: '/' },
            { label: 'Group Object Permissions', link: '/' },
            { label: 'Tags', link: '/' },
            { isLabel: true, label: 'Logs' },
            { label: 'Log Entries', link: '/' },
            { label: 'Host Logs', link: '/' },
            { label: 'Email Logs', link: '/' },
            { label: 'DNS Records Logs', link: '/' },
            { label: 'Address Logs', link: '/' },
